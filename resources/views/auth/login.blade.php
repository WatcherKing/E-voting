...
<div id="root" class="h-100">
    ...
    <div class="container-fluid p-0 h-100 position-relative">
        ...
        <div class="sw-lg-50 px-5">
            ...
            <div>
                <form action="{{ route('login.post') }}" class="tooltip-end-bottom"  method="POST" >
                    @csrf
                    ...
                    <div class="mb-3 filled form-group tooltip-end-top">
                        ...
                        <input class="form-control pe-7" name="password" type="password" placeholder="Voters Code" />
                    </div>
...
<!-- Theme Settings & Niches Buttons End --><!-- Vendor Scripts Start -->
