  ...
  <div class="page-title-container">
    <div class="row">
      <div class="col-12 col-sm-6">
        <h1 class="mb-0 pb-0 display-4">Contestants</h1>
      </div>
      <div class="col-12 col-sm-6 d-flex align-items-start justify-content-end">
        <!-- Tour Button Start -->
        <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#createContestants">Register
          Contestants</a>
        ...
        <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center justify-content-end">
                  <a href="{{ route('contestants.show', $contestant->id) }}" type="button"
                  ...
                  <button data-bs-toggle="modal" data-bs-target="#editContestant{{ $contestant->id }}"
                  ...
                  @include('contestants.modals.edit')
                  <a href="#" data-bs-toggle="modal" data-bs-target="#deleteContestant{{ $contestant->id }}"
                    ...
                    @include('contestants.modals.delete')
                </div>
              </td>
            </tr>
            @empty
            <th>
                <th scope="row" colspan="6" class="text-center">
                    <div class="text-warning text-center" >No Contestant found.</div>
                </th>
            </th>
...
@include('contestants.modals.create')
@endsection
